...
import { unwatchFolder, watchFolder } from '@main/services/watchManager'
...
// The watched-folder list itself. Split from settingsHandlers because these
// aren't settings writes: they rename directories on disk, restart chokidar
// watchers, and prune the photo/thumbnail stores. Channels keep their
// `settings:` prefix so the preload API is unchanged.
